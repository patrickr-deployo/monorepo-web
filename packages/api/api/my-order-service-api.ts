...
export const MyOrderServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        myOrderServiceGetMyOrder: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceListMyOrder2: async (body: V1ListOrderRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceRefundMyOrder: async (orderId: string, body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MyOrderServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async myOrderServiceGetMyOrder(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.myOrderServiceGetMyOrder(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MyOrderServiceApi.myOrderServiceGetMyOrder']?.[localVarOperationServerIndex]?.url;
        ...
        async myOrderServiceListMyOrder(pageOffset?: number, pageSize?: number, search?: string, sort?: Array<string>, fields?: string, filterId$eq?: string, filterId$neq?: string, filterId$contains?: string, filterId$startsWith?: string, filterId$nstartsWith?: string, filterId$endsWith?: string, filterId$nendsWith?: string, filterId$in?: Array<string>, filterId$nin?: Array<string>, filterId$null?: boolean, filterId$nnull?: boolean, filterId$empty?: boolean, filterId$nempty?: boolean, filterId$like?: string, filterName$eq?: string, filterName$neq?: string, filterName$contains?: string, filterName$startsWith?: string, filterName$nstartsWith?: string, filterName$endsWith?: string, filterName$nendsWith?: string, filterName$in?: Array<string>, filterName$nin?: Array<string>, filterName$null?: boolean, filterName$nnull?: boolean, filterName$empty?: boolean, filterName$nempty?: boolean, filterName$like?: string, filterCustomerId$eq?: string, filterCustomerId$neq?: string, filterCustomerId$contains?: string, filterCustomerId$startsWith?: string, filterCustomerId$nstartsWith?: string, filterCustomerId$endsWith?: string, filterCustomerId$nendsWith?: string, filterCustomerId$in?: Array<string>, filterCustomerId$nin?: Array<string>, filterCustomerId$null?: boolean, filterCustomerId$nnull?: boolean, filterCustomerId$empty?: boolean, filterCustomerId$nempty?: boolean, filterCustomerId$like?: string, afterPageToken?: string, beforePageToken?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListOrderReply>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MyOrderServiceApi.myOrderServiceListMyOrder']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async myOrderServiceListMyOrder2(body: V1ListOrderRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListOrderReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.myOrderServiceListMyOrder2(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MyOrderServiceApi.myOrderServiceListMyOrder2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async myOrderServiceRefundMyOrder(orderId: string, body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.myOrderServiceRefundMyOrder(orderId, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MyOrderServiceApi.myOrderServiceRefundMyOrder']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const MyOrderServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceGetMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceGetMyOrderRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Order> {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceListMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceListMyOrderRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<V1ListOrderReply> {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceListMyOrder2(requestParameters: MyOrderServiceApiMyOrderServiceListMyOrder2Request, options?: RawAxiosRequestConfig): AxiosPromise<V1ListOrderReply> {
         ...
         * @throws {RequiredError}
         */
        myOrderServiceRefundMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceRefundMyOrderRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Order> {
...
export class MyOrderServiceApi extends BaseAPI {
     ...
     */
    public myOrderServiceGetMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceGetMyOrderRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MyOrderServiceApi
     */
    public myOrderServiceListMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceListMyOrderRequest = {}, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MyOrderServiceApi
     */
    public myOrderServiceListMyOrder2(requestParameters: MyOrderServiceApiMyOrderServiceListMyOrder2Request, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MyOrderServiceApi
     */
    public myOrderServiceRefundMyOrder(requestParameters: MyOrderServiceApiMyOrderServiceRefundMyOrderRequest, options?: RawAxiosRequestConfig) {
