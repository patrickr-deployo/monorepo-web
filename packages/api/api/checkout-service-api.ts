...
// @ts-ignore
import type { CheckoutServiceCheckoutOrderRequest } from '../models';
// @ts-ignore
import type { GooglerpcStatus } from '../models';
// @ts-ignore
import type { V1CheckoutNowReply } from '../models';
// @ts-ignore
import type { V1CheckoutNowRequest } from '../models';
// @ts-ignore
import type { V1CheckoutOrderReply } from '../models';
/**
...
export const CheckoutServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        checkoutServiceCheckoutNow: async (body: V1CheckoutNowRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        checkoutServiceCheckoutOrder: async (orderId: string, body: CheckoutServiceCheckoutOrderRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CheckoutServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async checkoutServiceCheckoutNow(body: V1CheckoutNowRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1CheckoutNowReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.checkoutServiceCheckoutNow(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CheckoutServiceApi.checkoutServiceCheckoutNow']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async checkoutServiceCheckoutOrder(orderId: string, body: CheckoutServiceCheckoutOrderRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1CheckoutOrderReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.checkoutServiceCheckoutOrder(orderId, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CheckoutServiceApi.checkoutServiceCheckoutOrder']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const CheckoutServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        checkoutServiceCheckoutNow(requestParameters: CheckoutServiceApiCheckoutServiceCheckoutNowRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1CheckoutNowReply> {
         ...
         * @throws {RequiredError}
         */
        checkoutServiceCheckoutOrder(requestParameters: CheckoutServiceApiCheckoutServiceCheckoutOrderRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1CheckoutOrderReply> {
...
export class CheckoutServiceApi extends BaseAPI {
     ...
     */
    public checkoutServiceCheckoutNow(requestParameters: CheckoutServiceApiCheckoutServiceCheckoutNowRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof CheckoutServiceApi
     */
    public checkoutServiceCheckoutOrder(requestParameters: CheckoutServiceApiCheckoutServiceCheckoutOrderRequest, options?: RawAxiosRequestConfig) {
