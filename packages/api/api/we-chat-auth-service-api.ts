...
// @ts-ignore
import type { V1WeChatLoginReply } from '../models';
// @ts-ignore
import type { V1WechatMiniProgramCodeReq } from '../models';
// @ts-ignore
import type { V1WechatMiniProgramPhoneCodeReq } from '../models';
/**
...
export const WeChatAuthServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        weChatAuthServiceMiniProgramCode: async (body: V1WechatMiniProgramCodeReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        weChatAuthServiceMiniProgramPhoneCode: async (body: V1WechatMiniProgramPhoneCodeReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
...
export const WeChatAuthServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async weChatAuthServiceMiniProgramCode(body: V1WechatMiniProgramCodeReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1WeChatLoginReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.weChatAuthServiceMiniProgramCode(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeChatAuthServiceApi.weChatAuthServiceMiniProgramCode']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async weChatAuthServiceMiniProgramPhoneCode(body: V1WechatMiniProgramPhoneCodeReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1WeChatLoginReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.weChatAuthServiceMiniProgramPhoneCode(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeChatAuthServiceApi.weChatAuthServiceMiniProgramPhoneCode']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const WeChatAuthServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        weChatAuthServiceMiniProgramCode(requestParameters: WeChatAuthServiceApiWeChatAuthServiceMiniProgramCodeRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1WeChatLoginReply> {
         ...
         * @throws {RequiredError}
         */
        weChatAuthServiceMiniProgramPhoneCode(requestParameters: WeChatAuthServiceApiWeChatAuthServiceMiniProgramPhoneCodeRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1WeChatLoginReply> {
...
export class WeChatAuthServiceApi extends BaseAPI {
     ...
     */
    public weChatAuthServiceMiniProgramCode(requestParameters: WeChatAuthServiceApiWeChatAuthServiceMiniProgramCodeRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof WeChatAuthServiceApi
     */
    public weChatAuthServiceMiniProgramPhoneCode(requestParameters: WeChatAuthServiceApiWeChatAuthServiceMiniProgramPhoneCodeRequest, options?: RawAxiosRequestConfig) {
