...
// @ts-ignore
import type { V1DeleteNotificationReply } from '../models';
// @ts-ignore
import type { V1ListNotificationReply } from '../models';
// @ts-ignore
import type { V1ListNotificationRequest } from '../models';
// @ts-ignore
import type { V1Notification } from '../models';
/**
...
export const NotificationServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        notificationServiceDeleteNotification: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        notificationServiceGetNotification: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        notificationServiceListNotification: async (afterPageToken?: string, beforePageToken?: string, pageSize?: number, sort?: Array<string>, fields?: string, filterHasRead$eq?: boolean, filterHasRead$neq?: boolean, filterHasRead$null?: boolean, filterHasRead$nnull?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        notificationServiceListNotification2: async (body: V1ListNotificationRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        notificationServiceReadNotification: async (id: string, body: object, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const NotificationServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async notificationServiceDeleteNotification(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1DeleteNotificationReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.notificationServiceDeleteNotification(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationServiceApi.notificationServiceDeleteNotification']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async notificationServiceGetNotification(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Notification>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.notificationServiceGetNotification(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationServiceApi.notificationServiceGetNotification']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async notificationServiceListNotification(afterPageToken?: string, beforePageToken?: string, pageSize?: number, sort?: Array<string>, fields?: string, filterHasRead$eq?: boolean, filterHasRead$neq?: boolean, filterHasRead$null?: boolean, filterHasRead$nnull?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListNotificationReply>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationServiceApi.notificationServiceListNotification']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async notificationServiceListNotification2(body: V1ListNotificationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListNotificationReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.notificationServiceListNotification2(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationServiceApi.notificationServiceListNotification2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async notificationServiceReadNotification(id: string, body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.notificationServiceReadNotification(id, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationServiceApi.notificationServiceReadNotification']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const NotificationServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        notificationServiceDeleteNotification(requestParameters: NotificationServiceApiNotificationServiceDeleteNotificationRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1DeleteNotificationReply> {
         ...
         * @throws {RequiredError}
         */
        notificationServiceGetNotification(requestParameters: NotificationServiceApiNotificationServiceGetNotificationRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Notification> {
         ...
         * @throws {RequiredError}
         */
        notificationServiceListNotification(requestParameters: NotificationServiceApiNotificationServiceListNotificationRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<V1ListNotificationReply> {
         ...
         * @throws {RequiredError}
         */
        notificationServiceListNotification2(requestParameters: NotificationServiceApiNotificationServiceListNotification2Request, options?: RawAxiosRequestConfig): AxiosPromise<V1ListNotificationReply> {
         ...
         * @throws {RequiredError}
         */
        notificationServiceReadNotification(requestParameters: NotificationServiceApiNotificationServiceReadNotificationRequest, options?: RawAxiosRequestConfig): AxiosPromise<object> {
...
export class NotificationServiceApi extends BaseAPI {
     ...
     */
    public notificationServiceDeleteNotification(requestParameters: NotificationServiceApiNotificationServiceDeleteNotificationRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof NotificationServiceApi
     */
    public notificationServiceGetNotification(requestParameters: NotificationServiceApiNotificationServiceGetNotificationRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof NotificationServiceApi
     */
    public notificationServiceListNotification(requestParameters: NotificationServiceApiNotificationServiceListNotificationRequest = {}, options?: RawAxiosRequestConfig) {
     ...
     * @memberof NotificationServiceApi
     */
    public notificationServiceListNotification2(requestParameters: NotificationServiceApiNotificationServiceListNotification2Request, options?: RawAxiosRequestConfig) {
     ...
     * @memberof NotificationServiceApi
     */
    public notificationServiceReadNotification(requestParameters: NotificationServiceApiNotificationServiceReadNotificationRequest, options?: RawAxiosRequestConfig) {
