...
// @ts-ignore
import type { BrandServiceUpdateBrandRequest } from '../models';
// @ts-ignore
import type { GooglerpcStatus } from '../models';
// @ts-ignore
import type { V1Brand } from '../models';
// @ts-ignore
import type { V1CreateBrandRequest } from '../models';
// @ts-ignore
import type { V1DeleteBrandReply } from '../models';
// @ts-ignore
import type { V1ListBrandReply } from '../models';
// @ts-ignore
import type { V1ListBrandRequest } from '../models';
/**
...
export const BrandServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        brandServiceCreateBrand: async (body: V1CreateBrandRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        brandServiceDeleteBrand: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        brandServiceGetBrand: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        brandServiceListBrand2: async (body: V1ListBrandRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        brandServiceUpdateBrand: async (brandId: string, body: BrandServiceUpdateBrandRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        brandServiceUpdateBrand2: async (brandId: string, body: BrandServiceUpdateBrandRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'brandId' is not null or undefined
...
export const BrandServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async brandServiceCreateBrand(body: V1CreateBrandRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Brand>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceCreateBrand(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceCreateBrand']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async brandServiceDeleteBrand(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1DeleteBrandReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceDeleteBrand(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceDeleteBrand']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async brandServiceGetBrand(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Brand>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceGetBrand(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceGetBrand']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async brandServiceListBrand(pageOffset?: number, pageSize?: number, search?: string, sort?: Array<string>, fields?: string, filterId$eq?: string, filterId$neq?: string, filterId$contains?: string, filterId$startsWith?: string, filterId$nstartsWith?: string, filterId$endsWith?: string, filterId$nendsWith?: string, filterId$in?: Array<string>, filterId$nin?: Array<string>, filterId$null?: boolean, filterId$nnull?: boolean, filterId$empty?: boolean, filterId$nempty?: boolean, filterId$like?: string, filterCode$eq?: string, filterCode$neq?: string, filterCode$contains?: string, filterCode$startsWith?: string, filterCode$nstartsWith?: string, filterCode$endsWith?: string, filterCode$nendsWith?: string, filterCode$in?: Array<string>, filterCode$nin?: Array<string>, filterCode$null?: boolean, filterCode$nnull?: boolean, filterCode$empty?: boolean, filterCode$nempty?: boolean, filterCode$like?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListBrandReply>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceListBrand']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async brandServiceListBrand2(body: V1ListBrandRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListBrandReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceListBrand2(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceListBrand2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async brandServiceUpdateBrand(brandId: string, body: BrandServiceUpdateBrandRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Brand>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceUpdateBrand(brandId, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceUpdateBrand']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async brandServiceUpdateBrand2(brandId: string, body: BrandServiceUpdateBrandRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Brand>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.brandServiceUpdateBrand2(brandId, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BrandServiceApi.brandServiceUpdateBrand2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const BrandServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        brandServiceCreateBrand(requestParameters: BrandServiceApiBrandServiceCreateBrandRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Brand> {
         ...
         * @throws {RequiredError}
         */
        brandServiceDeleteBrand(requestParameters: BrandServiceApiBrandServiceDeleteBrandRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1DeleteBrandReply> {
         ...
         * @throws {RequiredError}
         */
        brandServiceGetBrand(requestParameters: BrandServiceApiBrandServiceGetBrandRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Brand> {
         ...
         * @throws {RequiredError}
         */
        brandServiceListBrand(requestParameters: BrandServiceApiBrandServiceListBrandRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<V1ListBrandReply> {
         ...
         * @throws {RequiredError}
         */
        brandServiceListBrand2(requestParameters: BrandServiceApiBrandServiceListBrand2Request, options?: RawAxiosRequestConfig): AxiosPromise<V1ListBrandReply> {
         ...
         * @throws {RequiredError}
         */
        brandServiceUpdateBrand(requestParameters: BrandServiceApiBrandServiceUpdateBrandRequest, options?: RawAxiosRequestConfig): AxiosPromise<V1Brand> {
         ...
         * @throws {RequiredError}
         */
        brandServiceUpdateBrand2(requestParameters: BrandServiceApiBrandServiceUpdateBrand2Request, options?: RawAxiosRequestConfig): AxiosPromise<V1Brand> {
...
export class BrandServiceApi extends BaseAPI {
     ...
     */
    public brandServiceCreateBrand(requestParameters: BrandServiceApiBrandServiceCreateBrandRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceDeleteBrand(requestParameters: BrandServiceApiBrandServiceDeleteBrandRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceGetBrand(requestParameters: BrandServiceApiBrandServiceGetBrandRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceListBrand(requestParameters: BrandServiceApiBrandServiceListBrandRequest = {}, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceListBrand2(requestParameters: BrandServiceApiBrandServiceListBrand2Request, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceUpdateBrand(requestParameters: BrandServiceApiBrandServiceUpdateBrandRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof BrandServiceApi
     */
    public brandServiceUpdateBrand2(requestParameters: BrandServiceApiBrandServiceUpdateBrand2Request, options?: RawAxiosRequestConfig) {
